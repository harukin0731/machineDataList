...
export function Switch4(props){
    ...
    return(
        <Pressable style={{backgroundColor:hoverState ? "#6B6B6B":"#262626", borderRadius:2, borderColor:hoverState ? "#FEFEFE5A" : "#9B9B9B70",borderWidth:hoverState ? 1 : 0,borderTopWidth:1,margin:20, userSelect:"none" }} onPress={onPress} onPressIn={()=>setHoverState(true)} onPressOut={()=>setHoverState(false)}>
