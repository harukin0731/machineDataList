...
export function Switch44(props){
    ...
    return(
        <Pressable style={{width:120,height:30, backgroundColor:"#262626", margin:20, flexDirection:"row", alignContent:"center", alignItems:"center", userSelect:"none"  }} onPress={onPress} onPressIn={()=>setHoverState(true)} onPressOut={()=>setHoverState(false)}>
